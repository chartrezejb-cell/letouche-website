...
import { Upload, Shirt, Sparkles, Camera, Heart, Share2, Search, Plus, ArrowLeft, Wand2 } from 'lucide-react';
...
function PhoneShell({ children }) {
  return (
    <div className="min-h-screen bg-[#f6f2eb] text-[#2a211c] flex items-center justify-center p-4">
      <div className="w-full max-w-sm min-h-[780px] rounded-[32px] bg-[#fbf8f3] shadow-2xl border border-[#eadfce] overflow-hidden">
        {children}
      </div>
    </div>
  );
...
export default function LeToucheStylingAppPrototype() {
  ...
  return (
    <PhoneShell>
      <motion.div key={view} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }} className="min-h-[780px] flex flex-col">
